...
if (process.argv.length < 3) {
  console.error('Usage: node generate-folder-structure.js <FolderName> <FileName>');
  process.exit(1);
}
// Get folder and file names from command-line arguments
const folderName = process.argv[2];
const fileName = process.argv[3];
const targetDirectory = path.join(__dirname, 'src', 'app', 'modules', folderName);
...
console.log(`Folder '${folderName}' and files created successfully in 'src/app/modules'.`);
